...
func main() {
	...
	lev2 := stringToGameMap("000000000\n001111100\n00S000000\n001111100\n001X00000\n001111100")
	...
	*/
	...
	gameState.Maps = append(gameState.Maps, lev9)
	gameState.Maps = append(gameState.Maps, lev10)
	gameState.Maps = append(gameState.Maps, lev11)
	gameState.Maps = append(gameState.Maps, lev12)*/
